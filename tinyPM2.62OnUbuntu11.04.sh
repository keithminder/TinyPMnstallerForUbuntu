...
#apt-get -y remove rpl default-jre tomcat6 tomcat6-admin tomcat6-common mysql-server-5.1 mysql-client-5.1 libmysql-java openjdk-6-jdk

apt-get -y install rpl default-jre tomcat6 tomcat6-admin tomcat6-common mysql-server-5.1 mysql-client-5.1 libmysql-java openjdk-6-jdk
}
